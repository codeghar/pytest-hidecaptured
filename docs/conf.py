# -*- coding: utf-8 -*-
#
# pytest-hidecaptured documentation build configuration file, created by
...
project = u'pytest-hidecaptured'
copyright = u'2015, Hamza Sheikh'
author = u'Hamza Sheikh'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-hidecaptured Documentation',
     [author], 1)
]
